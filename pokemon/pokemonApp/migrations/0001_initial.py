    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('natural_motion', models.ManyToManyField(related_name='%(class)s_natural_motion', to='pokemonApp.motion')),
                ...
                ('taught_motion', models.ManyToManyField(related_name='%(class)s_taught_motion', to='pokemonApp.motion')),
            ],
        ),
        migrations.AddField(
            model_name='pokemon',
