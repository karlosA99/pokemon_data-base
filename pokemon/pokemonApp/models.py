...
class Region(models.Model):
    id_Region = models.CharField(
        primary_key=True, max_length=30)  # id_regon = region_code
...
class Community(models.Model):
    ...
    id_Region = models.ForeignKey(
        Region, null=False, on_delete=models.RESTRICT)
...
class Citizen(models.Model):
    ...
    id_Community = models.ForeignKey(
        Community, on_delete=models.CASCADE, default=0)
...
class Gym(models.Model):
    ...
    leader = models.OneToOneField(
        Citizen, on_delete=models.RESTRICT, null=False)
...
class Motion(models.Model):
    ...
    element_name = models.ForeignKey(
        Element, null=False, on_delete=models.CASCADE)

    def __str__(self) -> str:
        return self.name


class NaturalMotion(models.Model):
...
class Trainer(Citizen):
    id_Gym = models.ForeignKey(
        Gym, null=True, on_delete=models.SET_NULL, blank=True, related_name="%(class)s_id_Gym")
    oponent = models.ManyToManyField(
...
class Species(models.Model):
    ...
    strong_element = models.ForeignKey(
        Element, on_delete=models.CASCADE, related_name="%(class)s_strong_element")
    secundary_element = models.ForeignKey(
...
class Duel(models.Model):
    trainer1 = models.ForeignKey(
        Trainer, on_delete=models.CASCADE, related_name="%(class)s_trainer1")
    trainer2 = models.ForeignKey(
        Trainer, on_delete=models.CASCADE, related_name="%(class)s_trainer2")
